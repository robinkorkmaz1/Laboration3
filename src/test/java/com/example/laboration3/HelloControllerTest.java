...
class HelloControllerTest {
    ...
    void undoClicked() {
        ...
        assertTrue(helloController.getShapes().get(0).getSize() == 50 &&
                helloController.getShapes().get(0).getColor().equals("red"));
        assertEquals(helloController.getOperations().size(), 1);
        helloController.undoClicked();
        assertEquals(helloController.getShapes().size(), 0);
        assertEquals(helloController.getOperations().size(), 0);
    }
